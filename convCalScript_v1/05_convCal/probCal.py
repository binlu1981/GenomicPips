...
if len(sys.argv)<3:
	print "Usage: probCal.py <genelist> <prefix>"
	sys.exit(2)


sptree = Tree("pseudoroot_mam_tree.txt",format=3)
GENE = open(sys.argv[1],'r')
#PAIR = open(sys.argv[2],'r')
prefix = sys.argv[2] # for prefix input anything you want to appear at start of output files
