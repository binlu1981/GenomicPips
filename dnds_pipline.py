...
if sys.version_info[0] > 2:
    dnds_csv = input("please input the name of the dnds csv file: ")
    species_focus = input("please input the name of your interesting taxon id in csv: ")
    species_backgroud = input("please input the name of your background taxon id in csv: ")
else:
    dnds_csv = raw_input("please input the name of the dnds csv file: ")
    species_focus = raw_input("please input the name of your interesting taxon id in csv: ")
    species_backgroud = raw_input("please input the name of your background taxon id in csv: ")

dnds = pd.read_csv(dnds_csv,header = 0)
print(dnds.head())
